...
// node_modules/barcode-detector/dist/es/zxing-exported-CNntLDmF.js
var e = [
  [
    "All",
    "*",
...
async function oe(e2 = {}) {
  ...
  var m2 = console.log.bind(console), h2 = console.error.bind(console), g2, _2 = false, ee2, v2, te2 = false;
  function y2() {
    var e3 = Xn.buffer;
  ...
  var Le = (e3, t3, n3, r3) => {
    ...
    return e4;
  }, Ve = (e4) => Be.unregister(e4), W(e3)) : (W = (e4) => e4, e3), We = [], Ge = () => {
    for (; We.length; ) {
      var e3 = We.pop();
    ...
    Object.assign(e3, {
      ...
      deleteLater() {
        return this.$$.ptr || ze(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && H("Object already scheduled for deletion"), We.push(this), We.length === 1 && Ke && Ke(Ge), this.$$.deleteScheduled = true, this;
      }
    });
  ...
  var Ot = (e3, t3, n3, r3, i3, a3) => {
    ...
    var u3 = Tt(n3, r3);
    t3 = B(t3), t3 = kt(t3), a3 = q(i3, a3, c3), z([], [e3], (e4) => {
      e4 = e4[0];
      var r4 = `${e4.name}.${t3}`;
    ...
    var c3 = Tt(t3, n3);
    e3 = B(e3), e3 = kt(e3), i3 = q(r3, i3, o3), Qe(e3, function() {
    ...
    U(e3, {
      ...
      fromWireType(e4) {
        ...
        if (n3) i3 = Xt(r3, t4, true);
          ...
          i3 = "";
          for (var a3 = 0; a3 < t4; ++a3) i3 += String.fromCharCode(D2[r3 + a3]);
        }
        return Q(e4), i3;
      },
      toWireType(e4, t4) {
        ...
        i3 || ArrayBuffer.isView(t4) && t4.BYTES_PER_ELEMENT == 1 || H("Cannot pass non-string to std::string"), r3 = n3 && i3 ? Kt(t4) : t4.length;
        var a3 = zn(4 + r3 + 1), o3 = a3 + 4;
        if (E2[a3 >> 2] = r3, i3) if (n3) X(t4, o3, r3 + 1);
        else for (var s3 = 0; s3 < r3; ++s3) {
          var c3 = t4.charCodeAt(s3);
          c3 > 255 && (Q(a3), H("String has UTF-16 code units that do not fit in 8 bits")), D2[o3 + s3] = c3;
        }
        else D2.set(t4, o3);
  ...
  function Fr(e3, t3, n3, r3, i3, a3, o3, s3, c3, l3, u3, d3, f3, p3, m3, h3, g3, _3, ee3, v3) {
    var te3 = k2();
    try {
      qn(e3, t3, n3, r3, i3, a3, o3, s3, c3, l3, u3, d3, f3, p3, m3, h3, g3, _3, ee3, v3);
    } catch (e4) {
  ...
  function Rr() {
    ...
    function e3() {
      var e4, t3;
      i2.calledRun = true, !_2 && (re2(), (e4 = ee2) == null || e4(i2), (t3 = i2.onRuntimeInitialized) == null || t3.call(i2), ie());
    }
...
function Ce(e2, t2) {
  return we(e2) ? new DOMException(`${t2}: ${e2.message}`, e2.name) : Te(e2) ? new e2.constructor(`${t2}: ${e2.message}`) : Error(`${t2}: ${e2}`);
}
function we(e2) {
...
export {
  ...
  outline,
  x as prepareZXingModule,
  ce as setZXingModuleOverrides,
  useDevices
};
